...
class ScheduleResult {
  ...
  factory ScheduleResult.fromJson(Map<String, dynamic> json) => ScheduleResult(
      ...
      currentPrincipalAmount: (json["current_principal_amount"] ?? 0).toDouble(),
      ...
      repaymentStartDate: json["repayment_start_date"] != null ? DateTime.parse(json["repayment_start_date"]) : null,
      ...
      disbursedAmount: (json["loan_loan_amount"] ?? 0).toDouble(),
      monthlyRepaymentAmount: (json["monthly_repayment_amount"] ?? 0).toDouble(),
      partnerMonthlyRepaymentAmount: (json["partner_monthly_repayment_amount"] ?? 0).toDouble(),
      ...
      repaymentSchedule: json["repayment_schedule"] != null
          ? List<RepaymentSchedule>.from(
              json["repayment_schedule"].map((x) => RepaymentSchedule.fromJson(x)))
          : [],
    );
  Map<String, dynamic> toJson() => {
        "name": name,
        ...
        "loan_loan_amount": disbursedAmount,
